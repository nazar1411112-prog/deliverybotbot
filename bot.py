...
TEXTS = {
    'ru': {
        ...
        'comment': "💬 Введите комментарий и напишите точный адрес (точку А и точку Б) текстом для курьера. Нажмите /skip для пропуска:",
    ...
    'ro': {
        ...
        'comment': "💬 Introduceți un comentariu sau scrieți adresa exactă (punctul A și punctul B) cu text simplu pentru curier. Apăsați /skip pentru a sări peste:",
    ...
    'en': {
       ...
       'comment': "💬 Enter a comment or write the exact address (point A and point B) in plain text for the courier. Press /skip to skip:",
