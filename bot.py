...
TEXTS = {
    'ru': {
        ...
        'comment': "💬 Введите комментарий для курьера и адреса точки А и Б текстом. Нажмите /skip для пропуска:",
    ...
    'en': {
        ...
        'comment': "💬 Enter a comment for the courier and the addresses of points A and B in text. Press /skip to skip:",
