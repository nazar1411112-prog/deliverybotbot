...
TEXTS = {
    'ru': {
        ...
        'comment': "💬 Введите комментарий/адрес текстом. Нажмите /skip для пропуска:",
    ...
    'ro': {
        ...
        'comment': "💬 Introduceți un comentariu. Apăsați /skip pentru a sări peste:",
    ...
    'en': {
        ...
        'comment': "💬 Enter a comment. Press /skip to skip:",
